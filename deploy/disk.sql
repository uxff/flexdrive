...
CREATE TABLE IF NOT EXISTS `user` (
  ...
  `lastLoginAt` timestamp NOT NULL DEFAULT '1999-01-01 00:00:00' COMMENT '最后登录时间',
...
CREATE TABLE IF NOT EXISTS `oper_log` (
  ...
  `created` timestamp NOT NULL DEFAULT '1999-01-01 00:00:00' COMMENT '操作时间',
  `updated` timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP COMMENT '更新时间',
...
CREATE TABLE IF NOT EXISTS `node` (
  ...
  `follow` varchar(40) NOT NULL DEFAULT '' COMMENT 'node name I follow',
  ...
  `created` timestamp NOT NULL DEFAULT '1999-01-01 00:00:00' COMMENT '添加时间',
  `updated` timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP COMMENT '更新时间',
  `status` tinyint(4) NOT NULL DEFAULT '1' COMMENT '状态 1=正常启用 2=注册超时 99=删除 ',
  `lastRegistered` timestamp NOT NULL DEFAULT '1999-01-01 00:00:00' COMMENT '最后注册时间',
  PRIMARY KEY (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4;
...
CREATE TABLE IF NOT EXISTS `share` (
  ...
  `expired` timestamp NOT NULL DEFAULT '1999-01-01 00:00:00' COMMENT '分享有效期',
  PRIMARY KEY (`id`),
