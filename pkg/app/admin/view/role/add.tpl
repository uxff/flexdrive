        ...
        <div class="col-md-8 col-md-offset-2">
    		<div class="panel panel-default">
			  	...
			  	<div class="panel-body">
                    <form accept-charset="utf-8" role="form" class="form-horizontal" method="POST" action="/role/add">
                        <div class="form-group">
                            <label for="inputName" class="col-sm-3 control-label">名称</label>
                            <div class="col-sm-8">
                            <input class="form-control" placeholder="例: 运营" name="name" value="" type="input" required 
                                        id="inputName" />
                            </div>
                        </div>
                        <!--下面编辑权限-->
