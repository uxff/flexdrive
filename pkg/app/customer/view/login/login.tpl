...
<div class="container">
    <div class="row vertical-offset-75">
    	<div class="col-md-6 col-md-offset-3">
			  	...
			  	<div class="panel-body">
			    	<form accept-charset="utf-8" role="form" class="form-horizontal" method="POST" action="/login">
                      ...
                      <div class="form-group">
                        ...
                        <div class="col-sm-8">
			    		            <input class="form-control" placeholder="输入密码" name="password" type="password" value="" required
          ...
          <div class="panel-footer text-center clearfix">没有账户 <a href="/signup">注册 »</a></div>
